...
const OrderReminder = require('./orderReminder');
...
// 1 Order có nhiều Reminder
Order.hasMany(OrderReminder, { foreignKey: 'orderId', as: 'reminders' });
OrderReminder.belongsTo(Order, { foreignKey: 'orderId' });
...
// product-promotion Định nghĩa quan hệ N-N
Product.belongsToMany(Promotion, { 
    through: ProductPromotion, 
    as: 'promotions', // Alias quan trọng để dùng khi query
    foreignKey: 'productId'
});
