...
// 👇 1. IMPORT FILE CRON VÀO ĐÂY
const initPriceUpdaterCron = require('./cron/priceUpdater');
...
const startServer = async () => {
  ...
  // 👇 2. KÍCH HOẠT CRONJOB Ở ĐÂY
  // Gọi hàm này để nó bắt đầu đếm giờ chạy ngầm
  initPriceUpdaterCron();
  logger.info('⏰ Cronjob system initialized (Price Updater).');
